...
RedFlower-Paper-Vimix() {

# Set Vimix-Dark Icon Theme
  echo "Setting RedFlower-Paper-Vimix..."
...
install() {
  ...
  if [ ! -d $DEST_DIR ]; then
    mkdir -p $DEST_DIR
  elif [[ -d $DEST_DIR/Vimix && -d $DEST_DIR/RedFlower-Paper-Vimix && -d $DEST_DIR/Paper-Vimix ]]; then
    replace $DEST_DIR
  fi
  ...
  cp -a Vimix RedFlower-Paper-Vimix Paper-Vimix $DEST_DIR
...
remove() {
  ...
  if [[ -d $DEST_DIR/Vimix && -d $DEST_DIR/RedFlower-Paper-Vimix & -d $DEST_DIR/Paper-Vimix ]]; then
